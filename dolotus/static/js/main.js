...
(function ($) {
	...
	$(".offcanvas-close-btn ,.main-menu-mobile .onepage-menu li a  > *:not(button)").on("click", function () {
	...
	if ($('.hero-active').length > 0) {
		var slider = new Swiper('.hero-active', {
			slidesPerView: 1,
			spaceBetween: 0,
			loop: true,
			effect: 'fade',
	...
	if ($('.testimonial-3-active').length > 0) {
		var slider = new Swiper('.testimonial-3-active', {
			slidesPerView: 2,
			spaceBetween: 30,
			loop: true,
			breakpoints: {
	...
	////////////////////////////////////////////////////
	// Blog Active
	if ($('.blog-post-active').length > 0) {
	var slider = new Swiper('.blog-post-active', {
		slidesPerView: 1,
		spaceBetween: 30,
		loop: true,
		breakpoints: {
